...
public class MaintenanceUrl {

    //TODO: expand this.
    public static final String CONTROLLER_DIRECTORY_URL = "/admin/";
    ...
    public static final String LIST_MAINTENANCE_PREVIEW_PAGE = CONTROLLER_DIRECTORY_URL + "disc-list-preview.cgi";
    ...
    public static final String RSS_MAINTENANCE_PAGE = CONTROLLER_DIRECTORY_URL + "disc-rss-maint.cgi";
