...
public enum ConfigurationProperty {
    ...
    STYLE_SHEET_STYLE_SETTING("stylesheet.url.style"),
    STYLE_SHEET_CUSTOM_CONFIGURATION ("stylesheet.url.custom.configuration"),
    STYLE_SHEET_URL_GRAPH ("stylesheet.url.graph"),
    STYLE_SHEET_URL_OCEAN ("stylesheet.url.ocean"),
    STYLE_SHEET_URL_CUTE ("stylesheet.url.cute"),
    STYLE_SHEET_URL_CYAN ("stylesheet.url.cyan"),
    STYLE_SHEET_URL_FOREST ("stylesheet.url.forest"),
    STYLE_SHEET_URL_MIDNIGHT ("stylesheet.url.midnight"),
    STYLE_SHEET_URL_STEELY ("stylesheet.url.steely"),
    STYLE_SHEET_URL_TRADITIONAL ("stylesheet.url.traditional"),
    STYLE_SHEET_URL_DEFAULT("stylesheet.url.default"),
    STYLE_SHEET_URL_MAINTENANCE ("stylesheet.url.maintenance"),
    ...
    EMAIL_IMPORT_UPLOAD_SUBJECT_TEMPLATE("email.notification.import.subject.template"),
    EMAIL_IMPORT_UPLOAD_BODY_TEMPLATE("email.notification.import.body.template");
